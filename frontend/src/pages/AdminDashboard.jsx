...
const AdminDashboard = () => {
  ...
  const menuItems = [
    ...
    { name: 'MSBTE Results', path: '/admin/msbte-results', icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
      </svg>
    )},
        ...
        <main className="flex-1 overflow-y-auto p-6">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 mb-8 animate-slide-up" style={{ animationDelay: '0.5s' }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <button
                onClick={() => navigate('/admin/msbte-results')}
                className="bg-gradient-to-r from-teal-500 to-cyan-600 text-white p-5 rounded-xl font-semibold shadow-md hover:shadow-2xl transform hover:scale-105 transition-all duration-300 flex items-center justify-center gap-3 group"
              >
                <svg className="w-6 h-6 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg>
