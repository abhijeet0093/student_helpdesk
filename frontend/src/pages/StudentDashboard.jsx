      ...
      <aside className={`${sidebarOpen ? 'w-64' : 'w-20'} bg-gradient-to-b from-indigo-600 via-indigo-700 to-indigo-900 text-white transition-all duration-300 flex flex-col shadow-2xl relative z-20 overflow-hidden`}>
        ...
        <div className="p-6 border-b border-indigo-500/30 relative z-10 animate-slide-up">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-white/20 rounded-xl flex items-center justify-center shadow-lg backdrop-blur-sm hover:scale-110 transition-transform duration-300 animate-float">
        ...
        <nav className="flex-1 p-4 space-y-2 relative z-10">
          {menuItems.map((item, index) => {
            ...
            return (
              ...
              >
                <span className={`transition-transform duration-300 ${isActive ? 'animate-bounce-in' : 'group-hover:scale-110'}`}>
                  {item.icon}
                </span>
        ...
        <div className="p-4 border-t border-indigo-500/30 relative z-10">
          <button
            ...
            className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-red-300 hover:bg-gradient-to-r hover:from-red-600 hover:to-red-700 hover:text-white transition-all duration-300 hover:scale-105 hover:shadow-lg group"
          >
